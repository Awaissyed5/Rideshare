import 'package:rideshare/Views/tabPages/update_profile.dart';
              ...
              if (!snapshot.hasData) {
                ...
                return ListView(
                  ...
                  children: [
                    ...
                    ProfileWidget(
                        imagePath: map.containsKey('userImage')
                            ? map['userImage']
                            : '',
                        onClicked: () async {}),
...
1.4.“Coins” refers to the prepaid payment instrument or the like which Users may exchange for Contents and services offered by RideShare which are provided for a fee within the Services. 
1.5.“Separate Terms and Conditions” means terms and conditions separate from these Terms and Conditions that pertain to the Services released or uploaded by RideShare under names such as “terms,” “guidelines,” “policies,” or the like.
...
RideShare may modify these Terms and Conditions when RideShare deems it to be necessary, within the scope of the purposes of the Services. In such case, RideShare will indicate the contents of the modified version of these Terms and Conditions, as well as the effective date of the modification, on the Services or on RideShare’s website, or will publicize the same to Users by notifying Users in the manner prescribed by RideShare.The modified version of these Terms and Conditions shall become effective as of the effective date thereof.
4.Account
...
5.Privacy
5.1.RideShare places top priority on the privacy of its Users.
5.2.RideShare promises to exercise the utmost care and attention to its security measures to ensure the safe management of any and all information collected from Users.
...
6.2.RideShare reserves the right to limit access to all or part of the Services by Users depending upon conditions that RideShare considers necessary, such as the age and identification of User, current registration status, and the like.
6.3.RideShare reserves the right to modify, at RideShare's discretion, all or part of the Services as RideShare determines necessary anytime without any prior notice to Users.
6.4.RideShare may cease providing all or part of the Services without any prior notice to Users in case of the occurrence of any of the following:
...
7.Advertisements
RideShare reserves the right to post advertisements for RideShare or a third party on the Services.
8.Restricted Matters
RideShare prohibits Users from engaging in any of the following acts when using the Services:
...
8.3.Acts that infringe intellectual property rights, such as copyrights, trademarks and patent rights, rights to fame, privacy, and all other rights granted by law or by a contract with RideShare and/or a third party;
...
8.5.Acts that lead to the misrepresentation of RideShare and/or a third party or that intentionally spread false information;
8.6.Acts of sending the same or similar messages to a large, indefinite number of Users (except for those approved by RideShare), indiscriminately adding other Users as friends or to group chats, or any other acts deemed by RideShare to constitute spamming;
8.7.Acts of exchanging the right to use the Services or Contents into cash, property or other economic benefits, other than by using the method prescribed by RideShare;
8.8.Acts of using the Services for sales, marketing, advertising, solicitation or other commercial purposes (except for those approved by RideShare); using the Services for the purpose of sexual conduct or obscene acts; using the Services for the purpose of meeting or engaging in sexual encounters with an unknown third party; using the Services for the purpose of harassment or libellous attacks against other Users; or otherwise using the Services for purposes other than as intended by the Services;
...
8.12.Acts of interfering with the servers and/or network systems of the Services; fraudulently manipulating the Services by means of bots, cheat tools, or other technical measures; deliberately using defects of the Services; making unreasonable inquires and/or undue claims such as repeatedly asking the same questions beyond what is necessary, and other acts of interfering with or hindering RideShare's operation of the Services or other Users’ use of the Services;
...
8.15.Acts other than those set forth in Clauses 13.1 to 13.14 that RideShare reasonably deems to be inappropriate.
9.NO WARRANTY
RideShare SHALL PROVIDE NO WARRANTY, EITHER EXPRESSLY OR IMPLIEDLY, WITH RESPECT TO THE SERVICES (INCLUDING THE SUBJECT CONTENTS), THAT THERE ARE NO DEFECTS (INCLUDING, WITHOUT LIMITATION, FAULTS WITH RESPECT TO SECURITY, ETC., ERRORS OR BUGS, OR VIOLATIONS OF RIGHTS) OR AS TO THE SAFETY, RELIABILITY, ACCURACY, COMPLETENESS, EFFECTIVENESS AND FITNESS FOR A PARTICULAR PURPOSE. RideShare WILL IN NO WAY BE RESPONSIBLE FOR PROVIDING USERS WITH THE SERVICES AFTER DELETING SUCH DEFECTS. 
10.Relationship between these Terms and Conditions and Laws and Regulations
If the terms of these Terms and Conditions violate any laws and regulations applicable to an agreement between Users and RideShare with respect to the Services (including, without limitation, the laws of the country), such terms, to the extent of such violation, shall not apply to the agreement with the Users; provided, however, that the remaining terms of these Terms and Conditions shall not be affected.'''),
            ],
          ),
        ),
        actions: [
